...
@Setter
@ToString
public class MemberSecurityDTO extends User implements OAuth2User {   // extends User 시큐리티 UserDetails
                                    // p754 implements OAuth2User 카카오 로그인 가능하게
